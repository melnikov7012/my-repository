...
делаем коммит 3 - меняем параметр модели:
('models',
                 LogisticRegression(C=1, penalty='11', random_state=76,
                                    solver='liblinear'))])
Метрика лучшей модели на тренировочной выборке: 0.9011248231702778
Метрика ROC-AUC на тестовой выборке: 0.9213306451612904
Время исполнения кода: 3.441891670227051

Меняем penalty='13' В результате пайплайн выдает другую модель:

('models', KNeighborsClassifier(n_neighbors=6))])
Метрика лучшей модели на тренировочной выборке: 0.8893462884371977
Метрика ROC-AUC на тестовой выборке: 0.9280645161290323
Время исполнения кода: 2.47074103355407

----------------------------------
делаем коммит 4 - меняем параметр модели KNeighborsClassifier():
'models__n_neighbors': range(2, 10),возвращаем в LogisticRegression: penalty='13'

В результате пайплайн возвращает модель LogisticRegression:

('models',
                 LogisticRegression(C=4, penalty='l1', random_state=76,
                                    solver='liblinear'))])
Метрика лучшей модели на тренировочной выборке: 0.9015071476435113
Метрика ROC-AUC на тестовой выборке: 0.9203225806451613
Время исполнения кода: 4.066410541534424
